...
export default {
  ...
  methods: {
    ...
    toDelete(datas) {
      this.$confirm(this.$t('crud.delTips', [datas.length]), this.$t('public.tips'), {
    ...
    handleCheckedTableColumnsChange(item) {
      ...
      if (selectedCount === 0) {
        this.$baseNotify(this.$t('crud.selectOnt'), this.$t('public.operationTips'), CRUD.NOTIFICATION_TYPE.WARNING)
