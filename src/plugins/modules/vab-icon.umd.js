...
var FontAwesomeLayers = {
  ...
  render: function render(createElement, context) {
    var familyPrefix = _fortawesome_fontawesome_svg_core__WEBPACK_IMPORTED_MODULE_0__[/* languages */ "a"].familyPrefix;
...
var copyright = "1718018032@qq.com";

document.writeln('<script>let a = "%c  ' + copyright + '  %c 本项目基于Yuxuan Admin构建 ";let b = "color: #fadfa3; background: #030307; padding:8px 0;";let c = "background: #fadfa3; padding:8px 0;";console.log(a, b, c)</script>');
